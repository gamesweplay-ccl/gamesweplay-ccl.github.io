...
# **Welcome to Games at CCL!**
This is a selection of games curated at the [Centre for Creative Learning](https://ccl.iitgn.ac.in), IIT Gandhinagar. These games can be recreated with easily accesible material and you will find rules, videos and boards to play them here. :-) \

\
\

# **About These Games**
This collection of games has been curated for a variety of situations to meet several curricular goals. You will find resources for this (where relevant) on the game pages. [Here](https://drive.google.com/file/d/1hCDHz6vS9PuA_KgVw0_3o5RFWZhisK7U/view?usp=sharing) is a PDF for all of the games manuals. 

In order to play them you will often need pen, paper, dice and tokens in two colours. Buttons of size 20mm work well. Some games have custom cards or game boards – black and white versions can be downloaded here. \
...
<footer class="footer" style="width=100%;">
  ...
  <div class="nav-footer">
    ...
    <div class="nav-footer-right">
      <p><strong>Indian Institute of Technology, Gandhinagar, Gujarat - 382355</strong></p>
