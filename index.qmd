...
<!-- <div class="types-of-games-section-break">
  <style>
    .types-of-games-section-break {
      width: 100%;
      margin: 2rem 0;
      text-align: center;
    }

    .types-of-games-section-break img {
      max-width: 750px;
      height: auto;
  ...
  <img src="static/images/types-of-games-poster.svg" alt="Types of Games Divider">
</div> -->
...
.word-item .label {
  ...
  <div class="word-item">
    ...
    <span class="desc">These are games for 1 player</span>
  </div>
  <div class="word-item">
    <span class="label">2 players</span>
    <span class="desc">Strategy games for 2 players</span>
  </div>
  <div class="word-item">
    <span class="label">Between 3 and 10</span>
    <span class="desc">Games for 3–10 players</span>
  </div>
  <div class="word-item">
    <span class="label">10 and more</span>
    <span class="desc">Games for 10+ players</span>
  </div>
</div> -->
```
