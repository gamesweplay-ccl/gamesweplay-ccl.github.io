  ...
  <div class="nav-footer">
    ...
    <div class="footer-bottom-text">
      <p style="margin-top: 30px; font-size: 0.85rem;"><i>
        <b>Curation and Game Variants:</b> Jyothi Krishnan. <b>Art and Graphic Design:</b> Parvathy Subramanian. <b>Website and Games Support:</b> Diya Shah, Neeldhara Misra, Shaumik Khanna, and Tanvi Chaubey.
      </i></p>
    </div>
