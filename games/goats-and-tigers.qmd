...
board_links: https://drive.google.com/file/d/15TpFdhwydZxAQZoqXE7YfSROmxEWgz9G/view?usp=sharing
complexity: ★★
external_links: https://gamesweplay-ccl.github.io/Goats-and-Tigers/
filename: goats-and-tigers
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/1IJvta9OxTwU8bgE58yfkP81LU8ektVKY/view?usp=sharing
players: '2'
rules_video: https://youtu.be/B5K18wXrlg8
summary: 3 tigers start on the board. Every round a goat is added, then a tiger moved.
  If able, a tiger can jump over a goat to capture it. Once all 15 goats are placed,
  they too move on their turn.The goats win if the tigers cannot move. Tigers win
  if they capture 5 goats.
time: '20'
title: Goats and Tigers
type: Strategy
walkthrough_video: https://youtu.be/B5K18wXrlg8
---
...
:::{.game-summary}
3 tigers start on the board. Every round a goat is added, then a tiger moved. If able, a tiger can jump over a goat to capture it. Once all 15 goats are placed, they too move on their turn.The goats win if the tigers cannot move. Tigers win if they capture 5 goats.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Goats-and-Tigers/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/B5K18wXrlg8" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/B5K18wXrlg8" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1IJvta9OxTwU8bgE58yfkP81LU8ektVKY/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/15TpFdhwydZxAQZoqXE7YfSROmxEWgz9G/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
