...
complexity: ★★
external_links: https://www.onlinesologames.com/tigers-and-goats#google_vignette
...
type: Strategy
walkthrough_video: https://www.youtube.com/watch?v=P1fsFhA81G0
---
...
:::{.game-actions}
```{=html}
<a href="https://www.onlinesologames.com/tigers-and-goats#google_vignette" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="#" target="_blank" class="btn disabled-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=P1fsFhA81G0" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
