...
:::{.game-stats}
```{=html}
<span class="tooltip-gamestats" data-tooltip=" minutes"><i class="fas fa-clock"></i></span>
<span class="tooltip-gamestats" data-tooltip="6-7 players"><i class="fas fa-users"></i></span>
...
<a href="#" target="_blank" class="btn disabled-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
