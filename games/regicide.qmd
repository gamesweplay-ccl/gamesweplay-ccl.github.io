...
complexity: ★★★
external_links: https://boardgamearena.com/gamepanel?game=regicide
filename: regicide
format:
  html:
    css: ../styles.css
...
:::{.game-actions}
<a href="https://boardgamearena.com/gamepanel?game=regicide" class="btn btn-play"><i class="fa fa-gamepad"></i> Play the game</a>
