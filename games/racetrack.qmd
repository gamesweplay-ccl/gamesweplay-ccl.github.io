...
board_links: https://drive.google.com/file/d/1tzoOiI12SlblAXL5u0ZY8bSxaPxerVjb/view?usp=sharing
complexity: ★★★
external_links: https://www.transum.org/Maths/Game/Vectors/
filename: racetrack
format:
  html:
    css: ../styles.css
...
:::{.game-stats}
```{=html}
<span class="tooltip-gamestats" data-tooltip="40 minutes"><i class="fas fa-clock"></i></span>
<span class="tooltip-gamestats" data-tooltip="1-4 players"><i class="fas fa-users"></i></span>
...
:::{.game-actions}
```{=html}
<a href="https://www.transum.org/Maths/Game/Vectors/" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/1T6Z_Xx0BaWO4MnQ7wxyZrAFwgAgrlDEV/view?usp=drive_link" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1tzoOiI12SlblAXL5u0ZY8bSxaPxerVjb/view?usp=sharing" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
