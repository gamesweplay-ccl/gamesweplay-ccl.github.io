...
complexity: ★★
external_links: https://cardgames.io/farkle/
filename: farkle
format:
  html:
    css: ../styles.css
...
:::{.game-actions}
```{=html}
<a href="https://cardgames.io/farkle/" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/176zXhb4zrd6QkfYX9ZvUIm0DX6v8it9-/view?usp=sharing" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/14XIy3gwLXFB1Dy55iHLeMbQOpSTIaRKI/view?usp=sharing" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
