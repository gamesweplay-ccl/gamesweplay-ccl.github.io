...
board_links: https://drive.google.com/file/d/1lC06sq9uQt2i2_Z7RZk8Im0w6CFhiPDD/view?usp=sharing
complexity: ★★★
external_links: https://gamesweplay-ccl.github.io/Konane/
filename: konane
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/1j0hr3-VRLXhLZC3WMU2tQaulajF88q0j/view?usp=sharing
players: '2'
rules_video: https://youtu.be/dAnbyMLSHDc
summary: An old Hawaiian checkers game. Konane starts with tokens on all spaces. Players
  remove 2 tokens to begin the game which proceeds with a player removing an opponent's
  piece from the board by jumping their piece over it. The player unable to move loses
  the game.
time: '30'
title: Konane
type: Strategy
walkthrough_video: https://www.youtube.com/watch?feature=shared&v=yCt59SxvK6k
---
...
:::{.game-summary}
An old Hawaiian checkers game. Konane starts with tokens on all spaces. Players remove 2 tokens to begin the game which proceeds with a player removing an opponent's piece from the board by jumping their piece over it. The player unable to move loses the game.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Konane/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/dAnbyMLSHDc" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?feature=shared&v=yCt59SxvK6k" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1j0hr3-VRLXhLZC3WMU2tQaulajF88q0j/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1lC06sq9uQt2i2_Z7RZk8Im0w6CFhiPDD/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
