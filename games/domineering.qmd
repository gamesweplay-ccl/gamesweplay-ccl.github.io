...
board_links: https://drive.google.com/file/d/1kWf65KrOGodDXbCXya4mt0qy1hp78-iF/view?usp=sharing
complexity: ★
external_links: https://kyleburke.info/DB/combGames/domineering.html
filename: domineering
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Dominoes
manual_links: https://drive.google.com/file/d/1fKF7fsjlAyRIlOgzIKgy4gFeWWlJtU6w/view?usp=sharing
players: '2'
rules_video: https://youtu.be/KUZFn-9_FmU
summary: 2 players, Lata and Raj, play a game of domino (placing or) shading. The
  two take turns shading 2 adjacent squares. Raj may only shade horizontally and Lata
  vertically. Whoever is able to make the last move wins the game.
time: '10'
title: Domineering
type: Strategy
walkthrough_video: https://www.youtube.com/watch?v=uK3VUSlAlW8&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=13
---
...
<span class="tooltip-gamestats" data-tooltip="Dominoes required"><i class="fas fa-clone"></i></span>
...
:::{.game-summary}
2 players, Lata and Raj, play a game of domino (placing or) shading. The two take turns shading 2 adjacent squares. Raj may only shade horizontally and Lata vertically. Whoever is able to make the last move wins the game.
:::

:::{.game-actions}
```{=html}
<a href="https://kyleburke.info/DB/combGames/domineering.html" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/KUZFn-9_FmU" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=uK3VUSlAlW8&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=13" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1fKF7fsjlAyRIlOgzIKgy4gFeWWlJtU6w/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1kWf65KrOGodDXbCXya4mt0qy1hp78-iF/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
