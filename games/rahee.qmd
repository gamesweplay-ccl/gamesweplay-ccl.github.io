---
airtable_id: reciy7kJ0rpwwxV0u
board_links: https://drive.google.com/file/d/1FmUKc5t7KFmC05jo_mhCW0Gkf98nYTwa/view?usp=sharing
complexity: ★★★
external_links: ''
filename: rahee
format:
  html:
    ...
    page-layout: full
game_format: Custom
manual_links: https://drive.google.com/file/d/1sqfQkzWZQWgJfis2IZRGmKZ3ZF9e2IfH/view?usp=sharing
players: 2-5
rules_video: ''
summary: '-'
time: '40'
...
<span class="tooltip-gamestats" data-tooltip="2-5 players"><i class="fas fa-users"></i></span>
...
<a href="https://drive.google.com/file/d/1sqfQkzWZQWgJfis2IZRGmKZ3ZF9e2IfH/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1FmUKc5t7KFmC05jo_mhCW0Gkf98nYTwa/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
