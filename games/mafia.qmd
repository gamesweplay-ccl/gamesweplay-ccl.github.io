...
format:
  html:
    ...
    page-layout: full
game_format: Nothing
manual_links: https://drive.google.com/file/d/12TFWo-Q2mLOBM53qG-tzVziIIMKZZNB4/view?usp=sharing
players: 3-20
rules_video: ''
summary: This is a multi-player social deduction game. Players are given the role
  of either townsfolk or mafia. The townsfolk want to remove the mafia from town and
  the mafia to kill atleast half the townsfolk.
time: '30'
title: Mafia
type: SEL
walkthrough_video: ''
...
:::{.game-summary}
This is a multi-player social deduction game. Players are given the role of either townsfolk or mafia. The townsfolk want to remove the mafia from town and the mafia to kill atleast half the townsfolk.
:::
...
<a href="https://drive.google.com/file/d/12TFWo-Q2mLOBM53qG-tzVziIIMKZZNB4/view?usp=sharing" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
