...
complexity: ★
external_links: https://gamesweplay-ccl.github.io/Tac-Tix/
filename: tac-tix
format:
  html:
    css: ../styles.css
...
players: '2'
rules_video: https://youtu.be/viVafTZaILI
...
title: Tac Tix
type: Strategy
walkthrough_video: https://youtu.be/TMviGJ-qQ54
---
...
:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Tac-Tix/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/viVafTZaILI" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/TMviGJ-qQ54" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
