...
complexity: ★★★
external_links: https://mathgameswithbaddrawings.com/games/LAP
filename: lap
format:
  html:
    css: ../styles.css
...
title: LAP
type: Science
walkthrough_video: https://www.youtube.com/watch?feature=shared&v=r9uKAQlMWdo
---
...
:::{.game-actions}
```{=html}
<a href="https://mathgameswithbaddrawings.com/games/LAP" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="#" target="_blank" class="btn disabled-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?feature=shared&v=r9uKAQlMWdo" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
