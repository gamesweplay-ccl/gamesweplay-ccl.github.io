...
board_links: https://drive.google.com/file/d/1_yf1q9FEa5wyormpVIxlP5P1uLbxarwc/view?usp=sharing
complexity: ★★★
external_links: https://gamesweplay-ccl.github.io/LAP/
filename: lap
format:
  html:
    css: ../styles.css
...
manual_links: https://drive.google.com/file/d/1MkhmBpA9BpLOjTfOJ88zTkjtQsjoGMtM/view?usp=sharing
players: '2'
rules_video: https://youtu.be/2XXm_CpM6zI
summary: Battleship's smarter older sibling! Lata and Raj each decide their tetromino
  maps. They now try to guess at each other's layout but probing locations on the
  map.
time: '30'
title: LAP
type: Science
walkthrough_video: https://youtu.be/zSXDZYkcGS8
---
...
:::{.game-summary}
Battleship's smarter older sibling! Lata and Raj each decide their tetromino maps. They now try to guess at each other's layout but probing locations on the map.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/LAP/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/2XXm_CpM6zI" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/zSXDZYkcGS8" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1MkhmBpA9BpLOjTfOJ88zTkjtQsjoGMtM/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1_yf1q9FEa5wyormpVIxlP5P1uLbxarwc/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
