---
airtable_id: recSivlA60vR8xQHF
board_links: ''
complexity: ★★
external_links: https://gamesweplay-ccl.github.io/Akkam-Pakkam/
filename: akkam-pakkam
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Dice
manual_links: https://drive.google.com/file/d/1SsUQcZCTkWYI_kJom3QX2fCm2hE7GgEq/view?usp=sharing
players: 2-100
rules_video: ''
...
:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Akkam-Pakkam/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/1SsUQcZCTkWYI_kJom3QX2fCm2hE7GgEq/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
