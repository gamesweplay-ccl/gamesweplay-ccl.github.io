...
:::{.game-actions}
```{=html}
<a href="https://www.solitaireparadise.com/games_list/peg-solitaire.html" class="btn btn-play"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="#" class="btn btn-watch disabled-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=p2nojU3QCCk&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=24" class="btn btn-watch"><i class="fa fa-video"></i> Watch us play</a>
...
<a href="https://drive.google.com/file/d/194DAyhiIGm08N-2q9NrDqiFRY_feAkQl/view?usp=sharing" class="btn btn-board"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
