...
complexity: ★
external_links: https://gamesweplay-ccl.github.io/Peg-Solitaire/
...
format:
  html:
    ...
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/1D2bPfJst9IoxOBcDiFrLhBFVo08JQRfO/view?usp=sharing
players: '1'
rules_video: https://youtu.be/pctLw_rxAYM
summary: This single-player game starts with pieces on all but one space on the board.
  Jumping a piece over another removes it from the board. The aim is to get to a single
  token.
time: '20'
title: Peg Solitaire
type: Strategy
...
:::{.game-summary}
This single-player game starts with pieces on all but one space on the board. Jumping a piece over another removes it from the board. The aim is to get to a single token.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Peg-Solitaire/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/pctLw_rxAYM" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=p2nojU3QCCk&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=24" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1D2bPfJst9IoxOBcDiFrLhBFVo08JQRfO/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/194DAyhiIGm08N-2q9NrDqiFRY_feAkQl/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
