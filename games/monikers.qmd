...
format:
  html:
    ...
    page-layout: full
game_format: Nothing
manual_links: https://drive.google.com/file/d/1iPSbqlhupUJW5__MO3tJEwppYxDnGopb/view?usp=sharing
players: 4-20
rules_video: ''
summary: A more involved version of charades, this game is played over several rounds.
  In the first round, players give verbal clues to get their group to guess as many
  words as possible. In subsequent rounds, with the same word list, players may use
  only a single word, actions and finally just the movement of one hand. The group
...
:::{.game-summary}
A more involved version of charades, this game is played over several rounds. In the first round, players give verbal clues to get their group to guess as many words as possible. In subsequent rounds, with the same word list, players may use only a single word, actions and finally just the movement of one hand. The group that guesses the most words wins the game.
:::
...
<a href="https://drive.google.com/file/d/1iPSbqlhupUJW5__MO3tJEwppYxDnGopb/view?usp=sharing" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
