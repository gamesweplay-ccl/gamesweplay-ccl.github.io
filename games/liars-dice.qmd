...
board_links: ''
complexity: ★★★
external_links: https://www.funnode.com/games/liars-dice
filename: liars-dice
format:
  html:
    css: ../styles.css
...
:::{.game-actions}
<a href="https://www.funnode.com/games/liars-dice" class="btn btn-play"><i class="fa fa-gamepad"></i> Play the game</a>
