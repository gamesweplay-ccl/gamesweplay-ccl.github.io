...
complexity: ★★★
external_links: gamesweplay-ccl.github.io/game-implementations/lines-of-action/start.html
...
:::{.game-actions}
```{=html}
<a href="gamesweplay-ccl.github.io/game-implementations/lines-of-action/start.html" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
