...
board_links: https://drive.google.com/file/d/1A6lVBbkZ3ddkFqcULpYpBJTzr7i-eu15/view?usp=sharing
complexity: ★★★
external_links: https://gamesweplay-ccl.github.io/Lines-of-Action/
...
format:
  html:
    ...
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/127OC1HbCecpP5SJFUllop8Von6Y3fmpa/view?usp=sharing
players: '2'
rules_video: https://youtu.be/ame2-mNySJY
summary: Lata and Raj place their pieces on opposite edges of the board. A piece moves
  in a line a number of steps equal to the number of pieces in that line, into an
  empty space or removing an opponent. The first to get all their pieces in a single
  cluster wins the game.
time: '20'
title: Lines of Action
type: Strategy
walkthrough_video: https://youtu.be/ame2-mNySJY
---
...
:::{.game-summary}
Lata and Raj place their pieces on opposite edges of the board. A piece moves in a line a number of steps equal to the number of pieces in that line, into an empty space or removing an opponent. The first to get all their pieces in a single cluster wins the game.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Lines-of-Action/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/ame2-mNySJY" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/ame2-mNySJY" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/127OC1HbCecpP5SJFUllop8Von6Y3fmpa/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1A6lVBbkZ3ddkFqcULpYpBJTzr7i-eu15/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
