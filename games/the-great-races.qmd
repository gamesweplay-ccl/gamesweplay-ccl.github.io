...
board_links: https://drive.google.com/file/d/1rEzmcnOTY3PEZ-r6xHt0_JgVHgzKwmoE/view?usp=sharing
complexity: ★★
external_links: https://gamesweplay-ccl.github.io/Great-Races/
...
format:
  html:
    ...
    page-layout: full
game_format: Dice
manual_links: https://drive.google.com/file/d/1wE1X1AxOgw4Zpvy86Ra0McjBla5kMkGB/view?usp=sharing
players: 2-6
rules_video: https://youtu.be/tW5nWPPW-RU
summary: Each player participates in 11 races. On a turn roll 4 dice and pair them
  up, adding their outcomes. Move on the races corresponding to these numbers. Once
  8 races are completed, players score for being first or secnd in a race. The twist
  is that the player to reach a finish spot laater takes the award!
time: '30'
title: The Great Races
type: Maths
walkthrough_video: https://youtu.be/tW5nWPPW-RU
---
...
<span class="tooltip-gamestats" data-tooltip="2-6 players"><i class="fas fa-users"></i></span>
...
:::{.game-summary}
Each player participates in 11 races. On a turn roll 4 dice and pair them up, adding their outcomes. Move on the races corresponding to these numbers. Once 8 races are completed, players score for being first or secnd in a race. The twist is that the player to reach a finish spot laater takes the award!
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Great-Races/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/tW5nWPPW-RU" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/tW5nWPPW-RU" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1wE1X1AxOgw4Zpvy86Ra0McjBla5kMkGB/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1rEzmcnOTY3PEZ-r6xHt0_JgVHgzKwmoE/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
