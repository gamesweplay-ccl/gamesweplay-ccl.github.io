...
complexity: ★★
external_links: https://game-of-amazons.vercel.app/
filename: amazons
format:
  html:
    css: ../styles.css
...
:::{.game-actions}
```{=html}
<a href="https://game-of-amazons.vercel.app/" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/1rQRDcDD8ifHQvya6Cy-BByJ2PdKk1_WI/view?usp=sharing" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
