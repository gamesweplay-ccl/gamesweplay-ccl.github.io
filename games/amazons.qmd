...
board_links: https://drive.google.com/file/d/1jY99f3wzGzpRD6L7184YoLptewLWFqdZ/view?usp=sharing
complexity: ★★
external_links: http://gamesweplay-ccl.github.io/game-implementations/amazons/start.html
filename: amazons
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/134LsRZg2JjBjmV8JTzuAqSjzxSxPWtxq/view?usp=sharing
players: '2'
rules_video: https://youtu.be/fmvcqWc5H4Y
summary: Start by placing tokens of two colours in the indicated space. These are
  your warrior queens, Amazons, and each moves like a chess queen (as far as they
  like in any direction). On a turn a piece must move and then shoot a flaming arrow.
  The arrow can land as far as you like, in any direction from the piece. Cross off
  the square where the Arrow lands. No piece or arrow can cross a burnt position.
  The last player able to take a turn (move and shoot) wins the game.
time: '20'
title: Amazons
type: Strategy
walkthrough_video: https://youtu.be/HEffC1fZQwU?si=4_HwNif9mqpInSMj
---
...
:::{.game-summary}
Start by placing tokens of two colours in the indicated space. These are your warrior queens, Amazons, and each moves like a chess queen (as far as they like in any direction). On a turn a piece must move and then shoot a flaming arrow. The arrow can land as far as you like, in any direction from the piece. Cross off the square where the Arrow lands. No piece or arrow can cross a burnt position. The last player able to take a turn (move and shoot) wins the game.
:::

:::{.game-actions}
```{=html}
<a href="http://gamesweplay-ccl.github.io/game-implementations/amazons/start.html" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/fmvcqWc5H4Y" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/HEffC1fZQwU?si=4_HwNif9mqpInSMj" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/134LsRZg2JjBjmV8JTzuAqSjzxSxPWtxq/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1jY99f3wzGzpRD6L7184YoLptewLWFqdZ/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
