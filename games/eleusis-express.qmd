...
board_links: ''
complexity: ★★★
external_links: https://gamesweplay-ccl.github.io/Eleusis-Express/
...
manual_links: https://drive.google.com/file/d/13hGETsCqAHi0t3UJuXEpPV9EhsVle6Mg/view?usp=sharing
players: 4-5
rules_video: ''
summary: In this game of inductive reasoning, the clue giver thinks of a rule. Players
  place cards from their hand trying to experimentally determine the clue-giver's
  rule.
time: '40'
...
:::{.game-summary}
In this game of inductive reasoning, the clue giver thinks of a rule. Players place cards from their hand trying to experimentally determine the clue-giver's rule.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Eleusis-Express/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/13hGETsCqAHi0t3UJuXEpPV9EhsVle6Mg/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
