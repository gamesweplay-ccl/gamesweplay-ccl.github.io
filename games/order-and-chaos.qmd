...
board_links: https://drive.google.com/file/d/1OUsBjw0csPAnR_IdLB6EDsxAoV4ZmPxw/view?usp=sharing
complexity: ★
external_links: https://www.onlinesologames.com/order-and-chaos#google_vignette
filename: order-and-chaos
format:
  html:
    css: ../styles.css
    page-layout: full
...
players: '2'
rules_video: ''
summary: One player builds, the other blocks — will order prevail or will chaos reign?
  A twist on Tic-Tac-Toe where both sides share the symbols but not the goal.
time: '20'
title: Order and Chaos
type: Strategy
walkthrough_video: https://www.youtube.com/watch?v=kMCxxG8l7o8&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=33
---
...
:::{.game-summary}
##### One player builds, the other blocks — will order prevail or will chaos reign? A twist on Tic-Tac-Toe where both sides share the symbols but not the goal.
:::

:::{.game-actions}
```{=html}
<a href="https://www.onlinesologames.com/order-and-chaos#google_vignette" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="#" class="btn disabled-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=kMCxxG8l7o8&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=33" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1knXAygjb8p1VdBJPmf0IR0hqtws56FsH/view?usp=drive_link" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1OUsBjw0csPAnR_IdLB6EDsxAoV4ZmPxw/view?usp=sharing" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
