...
board_links: https://drive.google.com/file/d/12l0QX49H8dJt2xY8ZKvJJQJH904P4uk2/view?usp=sharing
complexity: ★★
...
format:
  html:
    ...
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/17IwelPZs3r-0_e2-KsFcRuMxtp1fqKIL/view?usp=sharing
players: 1-100
rules_video: https://youtu.be/DFvWRSBo_iU
summary: Each player has a 5 x 5 grid onto which they place the digit called. A digit
  forms a link with neighbours that have the same value. Players aim to pack their
  digits in for the most points once the grid is full.
time: '20'
title: Digit Party
type: Maths
walkthrough_video: https://youtu.be/ZCc5jXzXL3c
---
...
:::{.game-summary}
Each player has a 5 x 5 grid onto which they place the digit called. A digit forms a link with neighbours that have the same value. Players aim to pack their digits in for the most points once the grid is full.
:::

:::{.game-actions}
```{=html}
<a href="https://digit.party/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/DFvWRSBo_iU" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/ZCc5jXzXL3c" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/17IwelPZs3r-0_e2-KsFcRuMxtp1fqKIL/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/12l0QX49H8dJt2xY8ZKvJJQJH904P4uk2/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
