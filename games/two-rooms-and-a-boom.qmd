...
format:
  html:
    ...
    page-layout: full
game_format: Custom
manual_links: https://drive.google.com/file/d/1tPT8-6C-yaBb8fq9HZeTX1o2Lu-c4WAf/view?usp=sharing
players: 10-30
rules_video: ''
summary: Each player recieves a card that indicates their team and character. The
  blue team has the president and the red team a bomber. Players are split into 2
  groups. Members of the red team aim to get president and bomber in the same room
  while members of the blue team aim to prevent this.
time: '10'
...
:::{.game-summary}
Each player recieves a card that indicates their team and character. The blue team has the president and the red team a bomber. Players are split into 2 groups. Members of the red team aim to get president and bomber in the same room while members of the blue team aim to prevent this.
:::
...
<a href="https://drive.google.com/file/d/1tPT8-6C-yaBb8fq9HZeTX1o2Lu-c4WAf/view?usp=sharing" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
