...
complexity: ★
external_links: https://www.battleshiponline.org/
...
:::{.game-actions}
```{=html}
<a href="https://www.battleshiponline.org/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
