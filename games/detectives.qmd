...
board_links: https://drive.google.com/file/d/1srEcOE0LFM18BosydvYTeTTIVV-SKVft/view?usp=sharing
complexity: ★★★
external_links: https://gamesweplay-ccl.github.io/Detectives/
filename: detectives
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Custom
manual_links: https://drive.google.com/file/d/1gPIKJKoAJlRp7wlMykQMm0jFIvrhLuqu/view?usp=sharing
players: 3-6
rules_video: https://youtu.be/vdsosdNd0RE
summary: The alphabet cards are shuffled, one removed and the rest distributed between
  the players. On a turn pass an opponent a query card to learn how many of those
  are in their hand. Players compete to deduce which card was removed.
time: '40'
title: Detectives
type: Maths
walkthrough_video: ''
...
:::{.game-summary}
The alphabet cards are shuffled, one removed and the rest distributed between the players. On a turn pass an opponent a query card to learn how many of those are in their hand. Players compete to deduce which card was removed.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Detectives/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/vdsosdNd0RE" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="#" target="_blank" class="btn disabled-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1gPIKJKoAJlRp7wlMykQMm0jFIvrhLuqu/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1srEcOE0LFM18BosydvYTeTTIVV-SKVft/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
