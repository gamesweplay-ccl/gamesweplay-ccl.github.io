...
board_links: ''
complexity: ★★
external_links: https://gamesweplay-ccl.github.io/Fake-Artist/
...
manual_links: https://drive.google.com/file/d/1YZGPOQovwTdKNdDTPodPxoVGIKWfv2z-/view?usp=sharing
players: 3-8
rules_video: ''
summary: Each player recieves a folded chit of paper with a word. All but one, the
  fake artist, receives the same word. They take turns drawing a curve on a shared
  sheet. After each has drawn 2 curves each (including the fake artist) points to
  another player, accusing them of being the fake. If most point to the fake, he has
  a chance to guess the word. If correct he wins. Otherwise the artists win. If they
  get it wrong, the fake wins.
time: '10'
title: Fake Artist
type: SEL
walkthrough_video: ''
...
:::{.game-summary}
Each player recieves a folded chit of paper with a word. All but one, the fake artist, receives the same word. They take turns drawing a curve on a shared sheet. After each has drawn 2 curves each (including the fake artist) points to another player, accusing them of being the fake. If most point to the fake, he has a chance to guess the word. If correct he wins. Otherwise the artists win. If they get it wrong, the fake wins.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Fake-Artist/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/1YZGPOQovwTdKNdDTPodPxoVGIKWfv2z-/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
