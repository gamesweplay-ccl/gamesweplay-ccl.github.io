...
board_links: ''
complexity: ★★★
external_links: https://gamesweplay-ccl.github.io/3-Red-1-Black/
...
manual_links: https://drive.google.com/file/d/1fhFWdgPjmE7LAocByIwt4YWAjR3yuOC5/view?usp=sharing
players: 3-8
rules_video: ''
summary: Each player gets 4 cards — 3 red and 1 black. Play proceeds around the table
  with each player placing a card in front of themselves or opening a bid on the number
  of reds on the table. Any player may raise the bid whoever wins starts revealing
  cards. First all their cards on the table then, starting from the top, cards in
  front of any number of opponents. If the revealer finds a black card, they lose
  a card. If they open all the cards they bid for they receive a point. First to 2
...
<span class="tooltip-gamestats" data-tooltip="3-8 players"><i class="fas fa-users"></i></span>
<span class="tooltip-gamestats" data-tooltip="Playing Cards required"><i class="fas fa-clone"></i></span>
...
:::{.game-summary}
Each player gets 4 cards — 3 red and 1 black. Play proceeds around the table with each player placing a card in front of themselves or opening a bid on the number of reds on the table. Any player may raise the bid whoever wins starts revealing cards. First all their cards on the table then, starting from the top, cards in front of any number of opponents. If the revealer finds a black card, they lose a card. If they open all the cards they bid for they receive a point. First to 2 points wins the game.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/3-Red-1-Black/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/1fhFWdgPjmE7LAocByIwt4YWAjR3yuOC5/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
