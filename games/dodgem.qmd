...
complexity: ★
external_links: https://gamesweplay-ccl.github.io/Dodgem/
filename: dodgem
format:
  html:
    css: ../styles.css
...
:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Dodgem/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
