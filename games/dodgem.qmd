...
complexity: ★
external_links: http://gamesweplay-ccl.github.io/game-implementations/dodgem/start.html
filename: dodgem
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/15oeODVzR-4Q3t6nD4V7JftYNCr6nquaO/view?usp=sharing
players: '2'
rules_video: https://youtu.be/nsR_q-2rG3g
summary: Lata and Raj race across their finish lines. Cars may not reverse or jump
  over each other. The player with no moves remaining wins the game.
time: '10'
title: Dodgem
type: Strategy
...
:::{.game-summary}
Lata and Raj race across their finish lines. Cars may not reverse or jump over each other. The player with no moves remaining wins the game.
:::

:::{.game-actions}
```{=html}
<a href="http://gamesweplay-ccl.github.io/game-implementations/dodgem/start.html" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/nsR_q-2rG3g" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=djgD-ZhJXAE&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=15" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/15oeODVzR-4Q3t6nD4V7JftYNCr6nquaO/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1-hHA8S61MEhhNrtNW3AsFPL_sOeNbCcU/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
