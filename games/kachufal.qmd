...
board_links: ''
complexity: ★★★
external_links: https://gamesweplay-ccl.github.io/Kachuful/
filename: kachufal
format:
  html:
    css: ../styles.css
...
manual_links: https://drive.google.com/file/d/1tdVE2QmDNpJ-nDwBubzBoRUSWZfcVX1L/view?usp=sharing
players: 3-7
rules_video: ''
summary: A different number of cards are dealt to players each round. Players decide
  how many tricks they believe they can win and the trump is set by drawing the top
  card. The hand size reduces from 10-1 over 10 rounds. Player who wins the most tricks
  also wins the game.
time: '30'
title: Kachufal
type: SEL
...
:::{.game-summary}
A different number of cards are dealt to players each round. Players decide how many tricks they believe they can win and the trump is set by drawing the top card. The hand size reduces from 10-1 over 10 rounds. Player who wins the most tricks also wins the game.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Kachuful/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/1tdVE2QmDNpJ-nDwBubzBoRUSWZfcVX1L/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
