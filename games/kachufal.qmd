...
board_links: ''
complexity: ★★★
external_links: https://www.funnode.com/games/kachuful
filename: kachufal
format:
  html:
    css: ../styles.css
...
:::{.game-actions}
```{=html}
<a href="https://www.funnode.com/games/kachuful" class="btn btn-play"><i class="fa fa-gamepad"></i> Play the game</a>
