...
:::{.game-actions}
```{=html}
<a href="https://www.novelgames.com/en/bowlingsolitaire/" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/1DmoAtOqVi_FfZYc7MWAkPeUDsuWowOja/view?usp=drive_link" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
