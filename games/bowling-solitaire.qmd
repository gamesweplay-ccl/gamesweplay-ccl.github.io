...
manual_links: https://drive.google.com/file/d/1eMdQyUM-K_OvELEdssm6-XUZ-fXOcsTw/view?usp=sharing
players: '1'
rules_video: ''
summary: Two suits of playing cards represent bowling pins and balls. A single player
  game, we use some number theory to hit as many of the pins as possible each round.
time: '20'
...
:::{.game-summary}
Two suits of playing cards represent bowling pins and balls. A single player game, we use some number theory to hit as many of the pins as possible each round.
:::
...
<a href="https://drive.google.com/file/d/1eMdQyUM-K_OvELEdssm6-XUZ-fXOcsTw/view?usp=sharing" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
