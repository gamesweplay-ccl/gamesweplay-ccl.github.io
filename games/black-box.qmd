...
format:
  html:
    ...
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/112okLyIyGE5Gq5EydoASpGQ30pLaME5u/view?usp=sharing
players: '2'
rules_video: ''
summary: One player decides the location of 5 atoms in a black box. The other shines
  light into the box and, using the rules of scattering, deduces the position of each
  atom.
time: '40'
title: Black box
...
:::{.game-summary}
One player decides the location of 5 atoms in a black box. The other shines light into the box and, using the rules of scattering, deduces the position of each atom.
:::
...
<a href="https://drive.google.com/file/d/112okLyIyGE5Gq5EydoASpGQ30pLaME5u/view?usp=sharing" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
