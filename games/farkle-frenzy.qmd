...
board_links: https://drive.google.com/file/d/14XIy3gwLXFB1Dy55iHLeMbQOpSTIaRKI/view?usp=sharing
complexity: ★★
external_links: https://gamesweplay-ccl.github.io/Farkle-Frenzy/
filename: farkle-frenzy
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Dice
manual_links: https://drive.google.com/file/d/176zXhb4zrd6QkfYX9ZvUIm0DX6v8it9-/view?usp=sharing
players: 3-5
rules_video: https://youtu.be/Wk57j_GOgHo
summary: A turn starts with 6 dice to roll. Set aside any number of dice, incrementing
  your score. Roll the remaining dice and again set aside any dice you want to long
  as score increases. If no die increments score, the turn ends at once with 0 points
  scored. If all 6 dice score, write your score down and take another turn! First
  to 10k wins the game.
time: '30'
title: Farkle Frenzy
type: Maths
walkthrough_video: https://youtu.be/uwz0It9QWzQ
---
...
:::{.game-summary}
A turn starts with 6 dice to roll. Set aside any number of dice, incrementing your score. Roll the remaining dice and again set aside any dice you want to long as score increases. If no die increments score, the turn ends at once with 0 points scored. If all 6 dice score, write your score down and take another turn! First to 10k wins the game.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Farkle-Frenzy/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/Wk57j_GOgHo" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/uwz0It9QWzQ" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/176zXhb4zrd6QkfYX9ZvUIm0DX6v8it9-/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/14XIy3gwLXFB1Dy55iHLeMbQOpSTIaRKI/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
