...
complexity: ★★
external_links: https://gamesweplay-ccl.github.io/13-Sheep/
filename: 13-sheep
format:
  html:
    css: ../styles.css
...
players: 1-100
rules_video: https://youtu.be/hFe0YCBIrNY
summary: A die is rolled each round. Players draw the fence corresponding to the outcome
  somewhere on their individual boards. Fences may not overlap, intersect or pass
  through bushes. The player who protects the most sheep at the end of the game wins.
time: '30'
title: 13 Sheep
type: Maths
walkthrough_video: ''
...
:::{.game-summary}
A die is rolled each round. Players draw the fence corresponding to the outcome somewhere on their individual boards. Fences may not overlap, intersect or pass through bushes. The player who protects the most sheep at the end of the game wins.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/13-Sheep/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/hFe0YCBIrNY" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
