...
board_links: https://drive.google.com/file/d/13tgr6Mg0HYBruBAi0bb77Ue5Qxvu8W-T/view?usp=sharing
complexity: ★★
external_links: https://michaelxing.com/UltimateTTT/v3/
filename: ultimate-tic-tac-toe
format:
  html:
    css: ../styles.css
    page-layout: full
...
players: '2'
rules_video: ''
summary: Win the small boards to conquer the big one — but every move sends your opponent
  somewhere new. A layered twist on a classic game where strategy and foresight rule
  the grid.
time: '20'
title: Ultimate Tic Tac Toe
type: Strategy
walkthrough_video: https://www.youtube.com/watch?v=qh09l5amhyg&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=65
---
...
:::{.game-summary}
##### Win the small boards to conquer the big one — but every move sends your opponent somewhere new. A layered twist on a classic game where strategy and foresight rule the grid.
:::

:::{.game-actions}
```{=html}
<a href="https://michaelxing.com/UltimateTTT/v3/" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="#" class="btn disabled-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=qh09l5amhyg&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=65" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1xowHu2tQxKcz1t2qHjovcCImUKOBhvHx/view?usp=drive_link" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/13tgr6Mg0HYBruBAi0bb77Ue5Qxvu8W-T/view?usp=sharing" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
