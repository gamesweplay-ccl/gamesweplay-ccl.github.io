...
complexity: ★
external_links: https://gamesweplay-ccl.github.io/Sequencium/
filename: sequencium
format:
  html:
    css: ../styles.css
...
players: '2'
rules_video: https://youtu.be/SiRGxM01WVY
...
title: Sequencium
type: Maths
walkthrough_video: https://youtu.be/M7X2pzGIePg
---
...
:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Sequencium/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/SiRGxM01WVY" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/M7X2pzGIePg" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
