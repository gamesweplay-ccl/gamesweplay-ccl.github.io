...
board_links: https://drive.google.com/file/d/1ca6qV6GLkGv3fQh94SbEYd-khD2eMXUw/view?usp=sharing
complexity: ★
external_links: https://mathgameswithbaddrawings.com/games/sequencium
filename: sequencium
format:
  html:
    css: ../styles.css
...
walkthrough_video: https://www.youtube.com/watch?v=OdHCSGjq4Og&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=4
---
...
:::{.game-actions}
```{=html}
<a href="https://mathgameswithbaddrawings.com/games/sequencium" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="#" class="btn disabled-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=OdHCSGjq4Og&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=4" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1Ad7MqjuQmAkOBa9xPEsDHxudAn64OqAM/view?usp=drive_link" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1ca6qV6GLkGv3fQh94SbEYd-khD2eMXUw/view?usp=sharing" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
