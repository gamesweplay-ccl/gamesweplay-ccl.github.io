...
complexity: ★★
external_links: https://gamesweplay-ccl.github.io/Star-Nim/
filename: star-nim
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/190_hG9XOY4w4a2RkrzRtMO00xI0A7WHc/view?usp=sharing
players: '2'
rules_video: https://youtu.be/dh2IlmmKtd4
summary: Lata and Raj take turns removing tokens from the board. On a turn they can
  always remove one token. They could remove two, if the tokens are connected by a
  line. The one who removes the last token wins the game.
time: '10'
title: Star Nim
type: Strategy
...
:::{.game-summary}
Lata and Raj take turns removing tokens from the board. On a turn they can always remove one token. They could remove two, if the tokens are connected by a line. The one who removes the last token wins the game.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Star-Nim/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/dh2IlmmKtd4" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=aUuKdv9YEBw&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=32" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/190_hG9XOY4w4a2RkrzRtMO00xI0A7WHc/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1jGA0nPOtyMxm7ae5klIYflRyR-HTGyAp/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
