...
complexity: ★★★
external_links: https://shaumikkhanna.github.io/dicey-dice/
filename: dicey-dice
format:
  html:
    css: ../styles.css
...
:::{.game-actions}
```{=html}
<a href="https://shaumikkhanna.github.io/dicey-dice/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
