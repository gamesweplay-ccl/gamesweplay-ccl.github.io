...
board_links: https://drive.google.com/file/d/1Ul4Z8kN_wIel8c9ppUArTZ_qCizRUN1O/view?usp=sharing
complexity: ★★★
external_links: https://gamesweplay-ccl.github.io/Dicey-Dice/
filename: dicey-dice
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Dice
manual_links: https://drive.google.com/file/d/1lY8hRocCEkJmlvx7U5QzDhVwdSE-NOHS/view?usp=sharing
players: 2-100
rules_video: https://youtu.be/dxfz1vdlN-k
summary: Players decide to place bets on up to 3 spaces on the board. 2 dice are rolled
  and payoffs earned for successful bids. The player with the most money after 10
  rounds wins the game.
time: '10'
title: Dicey Dice
type: Maths
walkthrough_video: https://youtu.be/B6hwki0xyHs
---
...
<span class="tooltip-gamestats" data-tooltip="2-100 players"><i class="fas fa-users"></i></span>
...
:::{.game-summary}
Players decide to place bets on up to 3 spaces on the board. 2 dice are rolled and payoffs earned for successful bids. The player with the most money after 10 rounds wins the game.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Dicey-Dice/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/dxfz1vdlN-k" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/B6hwki0xyHs" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1lY8hRocCEkJmlvx7U5QzDhVwdSE-NOHS/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1Ul4Z8kN_wIel8c9ppUArTZ_qCizRUN1O/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
