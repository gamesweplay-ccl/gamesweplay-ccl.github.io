...
complexity: ★★
external_links: https://corners-game.vercel.app/
filename: corners
format:
  html:
    css: ../styles.css
...
:::{.game-actions}
```{=html}
<a href="https://corners-game.vercel.app/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
