...
:::{.game-actions}
```{=html}
<a href="http://jotto.augiehill.com/single.jsp" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/1vXkZZ3UaeVwy_PcPCbVh03L6epdJ-ICJ/view?usp=sharing" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
