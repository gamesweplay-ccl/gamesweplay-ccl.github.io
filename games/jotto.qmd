...
board_links: ''
complexity: ★
external_links: https://gamesweplay-ccl.github.io/Jotto/
filename: jotto
format:
  html:
    css: ../styles.css
...
manual_links: https://drive.google.com/file/d/1R93L7JmWKHc1Ks2jkDjUt39gHdaQb874/view?usp=sharing
players: '2'
rules_video: ''
summary: Lata thinks of a word and writes blanks for each letter. Raj makes a guess
  and Lata has to tell him the number of letters common to his word and hers as well
  as the number that are in the right place. Play continues till the word is revealed.
time: '10'
title: Jotto
type: SEL
walkthrough_video: https://www.youtube.com/watch?v=EqZvrA5Pl-Q
---
...
:::{.game-summary}
Lata thinks of a word and writes blanks for each letter. Raj makes a guess and Lata has to tell him the number of letters common to his word and hers as well as the number that are in the right place. Play continues till the word is revealed.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Jotto/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="#" target="_blank" class="btn disabled-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=EqZvrA5Pl-Q" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1R93L7JmWKHc1Ks2jkDjUt39gHdaQb874/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
