...
board_links: https://drive.google.com/file/d/1w22VQ23aLo65Ot43IO5stLh5pa6Z-QFU/view?usp=sharing
complexity: ★
external_links: https://gamesweplay-ccl.github.io/Toads-and-Frogs/
...
format:
  html:
    ...
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/1CSdS8OsDntzW4JCKy9B9tw3q6u2ab3fz/view?usp=sharing
players: '2'
rules_video: https://youtu.be/4YFJebWmRuY
summary: Place 3 black (toad) tokens on the left most spaces and 3 white (frog) tokens
  on the rightmost spaces of the board. On a turn, a piece can move a single step
  (toward the centre of the board). They can also jump over an opponent piece into
  an empty space. The player who is able to make the last move wins the game.
time: '10'
...
:::{.game-summary}
Place 3 black (toad) tokens on the left most spaces and 3 white (frog) tokens on the rightmost spaces of the board. On a turn, a piece can move a single step (toward the centre of the board). They can also jump over an opponent piece into an empty space. The player who is able to make the last move wins the game.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Toads-and-Frogs/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/4YFJebWmRuY" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="#" target="_blank" class="btn disabled-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1CSdS8OsDntzW4JCKy9B9tw3q6u2ab3fz/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1w22VQ23aLo65Ot43IO5stLh5pa6Z-QFU/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
