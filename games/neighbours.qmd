...
complexity: ★
external_links: https://gamesweplay-ccl.github.io/Neighbours/
filename: neighbours
format:
  html:
    css: ../styles.css
...
players: 1-100
rules_video: https://youtu.be/UnmrWA6OywM
...
title: Neighbours
type: Maths
walkthrough_video: https://youtu.be/-guF2JhazaU
---
...
:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Neighbours/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/UnmrWA6OywM" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/-guF2JhazaU" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
