...
complexity: ★★
external_links: https://gamesweplay-ccl.github.io/Khatti-Mithai/
...
format:
  html:
    ...
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/1u8053pOth-judCJ52YbqL4rX2Pa-OnAv/view?usp=sharing
players: '2'
rules_video: https://youtu.be/T6h6SJAKkhs
summary: All the squares on the board are filled with white tokens -- except the bottom
  left corner which has a black piece. On a turn pick a token and remove it as well
  as all tokens above and to the right of it. Player who takes the black token loses
  the game.
time: '10'
title: Khatti Mithai
type: Strategy
...
:::{.game-summary}
All the squares on the board are filled with white tokens -- except the bottom left corner which has a black piece. On a turn pick a token and remove it as well as all tokens above and to the right of it. Player who takes the black token loses the game.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Khatti-Mithai/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/T6h6SJAKkhs" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=lvlPfr6sVbQ&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=25" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1u8053pOth-judCJ52YbqL4rX2Pa-OnAv/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/17AhG6yNTO4JRKP3xPD34FYDOxLHTlQgI/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
