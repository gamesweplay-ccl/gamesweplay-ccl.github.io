...
board_links: https://drive.google.com/file/d/1YAxqNT-v-0Kez_f13YIvXc0QcC4gk3xJ/view?usp=sharing
complexity: ★★
external_links: https://gamesweplay-ccl.github.io/Char-Par/
filename: char-par
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Tokens
manual_links: https://drive.google.com/file/d/1TX4Z2-oIbXFVMI7vUk_wnc0tMcFfFO9X/view?usp=sharing
players: '2'
rules_video: https://youtu.be/0Wl9EwZI0xg
summary: Lata and Raj each have 9 tokens in their colour that they take turns placing
  to the board, attempting to make a line of 3. Once a line is formed, an opponent
  piece is removed. Once all tokens are placed, tokens can be moved.
time: '20'
title: Char Par
type: Strategy
walkthrough_video: https://youtu.be/0Wl9EwZI0xg
---
...
:::{.game-summary}
Lata and Raj each have 9 tokens in their colour that they take turns placing to the board, attempting to make a line of 3. Once a line is formed, an opponent piece is removed. Once all tokens are placed, tokens can be moved.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Char-Par/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/0Wl9EwZI0xg" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://youtu.be/0Wl9EwZI0xg" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1TX4Z2-oIbXFVMI7vUk_wnc0tMcFfFO9X/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1YAxqNT-v-0Kez_f13YIvXc0QcC4gk3xJ/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
