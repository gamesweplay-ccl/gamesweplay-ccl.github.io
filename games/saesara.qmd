...
complexity: ★★★
external_links: https://gamesweplay-ccl.github.io/Saesara/
filename: saesara
format:
  html:
    css: ../styles.css
...
players: 3-5
rules_video: ''
summary: A game of inductive reasoning, in Saesara players aim to unravel the clue
  giver's secret rule.
time: '20'
title: Saesara
type: Science
...
:::{.game-summary}
A game of inductive reasoning, in Saesara players aim to unravel the clue giver's secret rule.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Saesara/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/1mnTlANP5uZebd3YwDlDMBRzPM3xVu99x/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1Y1Bis1nIgApXKX2tnUseomMoItomqJWw/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
