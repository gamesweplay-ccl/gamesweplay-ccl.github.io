...
board_links: ''
complexity: ★★
external_links: http://gamesweplay-ccl.github.io/game-implementations/aces-and-faces/start.html
...
manual_links: https://drive.google.com/file/d/120LHDaU89q7d0vlP6TfsFwR7ZjRc7mh3/view?usp=sharing
players: '2'
rules_video: https://youtu.be/HGuviZDVEpA
summary: This game is played with only the Aces, Jacks, Queens and Kings from a deck
  of cards. Each cards has four characteristics (colour, gender, suit type and royalty).
  Lata and Raj give each other a card to place each round. The first to make a line
  of four with shared characteristic wins.
time: '20'
title: Aces and Faces
type: Maths
walkthrough_video: https://www.youtube.com/watch?v=n_ifx_HLdrk&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=2
---
...
:::{.game-summary}
This game is played with only the Aces, Jacks, Queens and Kings from a deck of cards. Each cards has four characteristics (colour, gender, suit type and royalty). Lata and Raj give each other a card to place each round. The first to make a line of four with shared characteristic wins.
:::

:::{.game-actions}
```{=html}
<a href="http://gamesweplay-ccl.github.io/game-implementations/aces-and-faces/start.html" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/HGuviZDVEpA" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="https://www.youtube.com/watch?v=n_ifx_HLdrk&list=PLmjuVk9xK8Lo3M4KZXFilobMBjNXIEOwq&index=2" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/120LHDaU89q7d0vlP6TfsFwR7ZjRc7mh3/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
```
:::
