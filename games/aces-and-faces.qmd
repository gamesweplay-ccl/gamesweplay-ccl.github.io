...
board_links: ''
complexity: ★★
external_links: http://gamesweplay-ccl.github.io/game-implementations/aces-and-faces/
...
:::{.game-actions}
```{=html}
<a href="http://gamesweplay-ccl.github.io/game-implementations/aces-and-faces/" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
