...
complexity: ★★
external_links: https://mathgameswithbaddrawings.com/games/paper-boxing
...
:::{.game-actions}
```{=html}
<a href="https://mathgameswithbaddrawings.com/games/paper-boxing" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
