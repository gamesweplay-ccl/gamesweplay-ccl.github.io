...
board_links: https://drive.google.com/file/d/1Z2yQWrqNrijHT2q9PWCL9-lEAoIfH1_-/view?usp=sharing
complexity: ★★
external_links: https://gamesweplay-ccl.github.io/Paper-Boxing/
...
manual_links: https://drive.google.com/file/d/1yWhxXahX4fdhM-dpdVMOrZ_sqNyYXiBr/view?usp=sharing
players: '2'
rules_video: https://youtu.be/C_dz6SPVMtc
summary: Leaving the top-left corner of the board empty, Lata and Raj secretly enter
  the numbers from 1 to 15 into their 4 x 4 grid boards. Each round, by connecting
  to the previous number, they select the number for the bout, comparing it to the
  other player's. The higher number wins the bout for a point. Play continues with
  players extending their lines to an empty neighbour selecting the new number to
  box. Play continues till all numbers are used or it is no longer possible to play
  and the player with hihgest score wins.
time: '20'
title: Paper Boxing
type: Maths
walkthrough_video: ''
...
:::{.game-summary}
Leaving the top-left corner of the board empty, Lata and Raj secretly enter the numbers from 1 to 15 into their 4 x 4 grid boards. Each round, by connecting to the previous number, they select the number for the bout, comparing it to the other player's. The higher number wins the bout for a point. Play continues with players extending their lines to an empty neighbour selecting the new number to box. Play continues till all numbers are used or it is no longer possible to play and the player with hihgest score wins.
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/Paper-Boxing/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
<a href="https://youtu.be/C_dz6SPVMtc" target="_blank" class="btn coloured-button"><i class="fa fa-video"></i> Rules video</a>
<a href="#" target="_blank" class="btn disabled-button"><i class="fa fa-video"></i> Watch us play</a>
<a href="https://drive.google.com/file/d/1yWhxXahX4fdhM-dpdVMOrZ_sqNyYXiBr/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/1Z2yQWrqNrijHT2q9PWCL9-lEAoIfH1_-/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
