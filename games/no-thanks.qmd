...
board_links: https://drive.google.com/file/d/17jsm303J_KP7-yjGYtXbO30n7NbiTu9x/view?usp=sharing
complexity: ★★
external_links: https://gamesweplay-ccl.github.io/No-Thanks/
filename: no-thanks
format:
  html:
    css: ../styles.css
    page-layout: full
game_format: Custom
manual_links: https://drive.google.com/file/d/1zvNDh-BgSM0_LeYG-AEdriXPbqWWrl6B/view?usp=sharing
players: 3-6
rules_video: ''
summary: Reveal a card. Either take it or place a token and pass it along. Cards give
  points and tokens reduce them. The player with the least points wins!
time: '30'
title: No Thanks
type: Maths
walkthrough_video: ''
...
:::{.game-summary}
Reveal a card. Either take it or place a token and pass it along. Cards give points and tokens reduce them. The player with the least points wins!
:::

:::{.game-actions}
```{=html}
<a href="https://gamesweplay-ccl.github.io/No-Thanks/" target="_blank" class="btn coloured-button"><i class="fa fa-gamepad"></i> Play the game</a>
...
<a href="https://drive.google.com/file/d/1zvNDh-BgSM0_LeYG-AEdriXPbqWWrl6B/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-book"></i> Read the manual</a>
<a href="https://drive.google.com/file/d/17jsm303J_KP7-yjGYtXbO30n7NbiTu9x/view?usp=sharing" target="_blank" class="btn coloured-button"><i class="fa fa-file-pdf"></i> Printable PDF</a>
```
:::
